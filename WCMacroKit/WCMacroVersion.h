...
// >= `16.0`
#ifndef IOS16_OR_LATER
#define IOS16_OR_LATER          ([[[UIDevice currentDevice] systemVersion] compare:@"16.0" options:NSNumericSearch] != NSOrderedAscending)
#endif

// >= `17.0`
#ifndef IOS17_OR_LATER
...
// >= `26.0`
#ifndef IOS26_OR_LATER
#define IOS26_OR_LATER          ([[[UIDevice currentDevice] systemVersion] compare:@"26.0" options:NSNumericSearch] != NSOrderedAscending)
#endif
